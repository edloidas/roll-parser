...
> features) are implemented with 1,000+ tests, 100% function coverage, and a
> property-based test suite. Remaining before beta: rich JSON `parts` output
> ([#84](https://github.com/edloidas/roll-parser/issues/84)).
>
...
|-----------|------|
| `parse('2d6+3')` | ~0.4 µs |
| `roll('1d20+5')` | ~2 µs (~500k rolls/s) |
| `roll('4d6kh3')` | ~5 µs |
| `evaluate(parse('100d6'))` | ~18 µs |
